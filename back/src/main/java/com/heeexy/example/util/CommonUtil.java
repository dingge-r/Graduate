...
public class CommonUtil {
     ...
     */
	public static JSONObject successPage(int totalPage, List<JSONObject> list, long totalCount) {
...
//		result.put("info", info);
    ...
    public static JSONObject successPage1(JSONObject  requestJson, List<JSONObject> list, int totalCount) {
		int pageRow = requestJson.getIntValue("pageRow");
		int totalPage = getPageCounts(pageRow, totalCount);
		JSONObject result = successJson();
        JSONObject info = new JSONObject();
	...
	public static JSONObject fail(String message) {
		JSONObject resultJson = new JSONObject();
		resultJson.put("code",ErrorEnum.E_402.getErrorCode());
